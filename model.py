...
Xbatch = reader.create_pipeline('testdp.csv', 1, 2)
...
with tf.Session() as sess:
    ...
    try:
        ...
        if isTrain:
            ...
            saver.restore(sess, 'ckpt/sm_softmax2-ckpt')
            x=namedecoder.disease2onehot('J40')
    ...
    if isTrain:
        saver.save(sess,'ckpt/sm_softmax2-ckpt')
    coord.join(threads)
    sess.close()
